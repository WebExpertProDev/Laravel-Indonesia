...
@endsection
 <div class="container">
    <h5 class="hd-main text-center">User Change Password</h5>
    <div class="edit-form">
<form method  = "POST" action = "{{route('user-list.password-store', $user->id)}}">
	{{csrf_field()}}
      <div class="row">
        <div class="col-md-12">
          <div class="left-side">
            <h6>User Change Password</h6>
			  ...
			  @endif
                ...
                <label class="sr-only" for="inlineFormInputGroup3">Password</label>
                  <div class="input-group p-0">
                    ...
                    <input type="password" class="form-control" name = "password" id="inlineFormInputGroup3" placeholder="Password">
                  </div>
              </div>
              <div class="form-group">
			  ...
			  @endif
                ...
                <label class="sr-only" for="inlineFormInputGroup4">Confirm Password</label>
                  <div class="input-group p-0">
                    ...
                    <input type="password" class="form-control" id="inlineFormInputGroup4" name = "confirm_password" placeholder="Confirm Password">
                  </div>
              </div>
