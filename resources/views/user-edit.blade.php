...
@endsection
 <div class="container">
    ...
    <div class="edit-form">
<form method = "post" action = "{{route('user-list.update', $users->id)}}">
	{{csrf_field()}}
	@method('PATCH')
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <label class="sr-only" for="inlineFormInputGroup1">Name</label>
                <div class="input-group p-0">
                  ...
                  <input value = "{{$users->name}}" type="text" class="form-control" required name  = "name" id="inlineFormInputGroup1" placeholder="Name">
                </div>
              </div>
               <div class="form-group">
			  ...
			  @endif
                  <div class="input-group p-0">
                    ...
                    <input value = "{{$users->email}}" type="email" required name = "email" class="form-control" id="inlineFormInputGroup2" placeholder="Email">
                  </div>
              </div>
              <div class="form-group">
			  ...
			  @endif
                  <div class="input-group p-0">
                    ...
                    <select {{$users->id == 1 ? 'disabled' : ''}} name = "role_id" type="text" class="form-control" id="inlineFormInputGroup5">
